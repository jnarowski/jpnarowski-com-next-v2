...
export const metadata = {
  ...
  description:
    "Insights from podcast interviews and talks on tech, featuring discussions about work-life harmony and entrepreneurship.",
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <p className="text-base md:text-lg lg:text-xl text-muted-foreground mb-6 md:mb-8">
            I&apos;ve been interviewed for a number of podcasts and given talks
            on tech, entrepreneurship, and building successful businesses.
          </p>
          ...
          <Card className="bg-muted/50">
            <CardContent className="p-6">
              ...
              <p className="text-sm md:text-base text-foreground/90 mb-4 leading-relaxed">
                I&apos;m currently focusing on AI and building in public. I love
                sharing my experiences with entrepreneurship, technical
                leadership, and the evolving AI landscape.
              </p>
              <p className="text-sm md:text-base text-foreground/90 leading-relaxed">
                If you&apos;re interested in having me on your podcast or speak
                at your event, please{" "}
                <Link
